...
def main():
    ...
    df_full = get_scores_dataframe(TARGET_DOMAINS_UNUSED)
    df_chosen = get_scores_dataframe(TARGET_DOMAINS)
    pd.set_option("display.max_columns", None)
    print(df_full)
    vizualize_domain_overlaps(
        df_chosen, TARGET_DOMAINS, thesis_file("chosen_domains_overlap.png")
    )
    vizualize_domain_overlaps(
        df_full, TARGET_DOMAINS_UNUSED, thesis_file("full_domains_overlap.png")
    )
    vizualize_domain_overlaps(df_full, None, thesis_file("unclean_domains_overlap.png"))
